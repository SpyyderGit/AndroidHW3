package com.example.superuser.project_240916.ui.adapters;
...
import com.example.superuser.project_240916.ui.fragments.StoreFragment;
import com.example.superuser.project_240916.ui.fragments.ToolFragment;
...
public class StoreAdapter extends RecyclerView.Adapter<StoreAdapter.StoreHolder> {
    ...
    public void onBindViewHolder(StoreHolder holder, int position) {
        final StoreTest store = (StoreTest) mStoreData.get(position);
        ...
        holder.cardStore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentTransaction.replace(R.id.conteiner, toolFragment);
